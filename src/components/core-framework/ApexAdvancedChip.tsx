...
export interface ApexAdvancedChipItem {
  id: string | number;
  label: string;
...
export interface ApexAdvancedChipProps<T extends ApexAdvancedChipItem = ApexAdvancedChipItem> {
  items: T[];
...
function ApexAdvancedChipInner<T extends ApexAdvancedChipItem>(
  {
    items,
    template,
    labelTemplate,
...
const ApexAdvancedChip = React.forwardRef(ApexAdvancedChipInner) as <
  T extends ApexAdvancedChipItem = ApexAdvancedChipItem,
>(
  props: ApexAdvancedChipProps<T> & { ref?: React.Ref<HTMLDivElement> },
) => React.ReactElement;

export default ApexAdvancedChip;
