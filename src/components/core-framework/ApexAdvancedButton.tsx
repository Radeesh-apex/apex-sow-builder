...
interface ApexAdvancedButtonProps {
  label: string;
...
const ApexAdvancedButton: React.FC<ApexAdvancedButtonProps> = ({
  label,
  onClick,
  startIcon,
  size = "medium",
    ...
    <Button
      ...
      sx={{
        ...
        ...(pulse && !loading && !disabled && {
          animation: `apexPulse ${pulseDuration}ms ease-in-out infinite`,
          "@keyframes apexPulse": {
...
export default ApexAdvancedButton;
