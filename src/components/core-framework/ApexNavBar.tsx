...
type ApexNavBarSize = "small" | "medium" | "large" | "dense";
...
const sizePresets: Record<ApexNavBarSize, { toolbarMinHeight: number; toolbarPaddingY: number; navGap: number; brandFontSize: string; itemFontSize: string }> = {
  small: {
    toolbarMinHeight: 52,
    toolbarPaddingY: 0.5,
    navGap: 1,
...
const ApexNavBar: React.FC<ApexNavBarProps> = ({
  brand = "ApexNavBar",
  logo,
  items = [],
  position = "static",
