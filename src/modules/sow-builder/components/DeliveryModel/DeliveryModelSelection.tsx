...
// Make sure to update this import path to your delivery models data source
...
export const DeliveryModelSelection: React.FC<DeliveryModelSelectionProps> = ({
    selectedIds = new Set(),
    onSelect,
}) => {
    ...
    return (
        <Box>
            {/* Header section updated from "Services" to "Delivery Model" */}
            ...
            <Grid container spacing={1.5}>
                {DELIVERY_MODELS_DATA.map((model) => {
                            ...
                            >
                                ...
                                >
                                    ...
                                    <Box sx={{ flex: 1 }}>
                                        ...
                                        {/* Only rendering sub-info if duration/effort are provided */}
                                        {(model.duration || model.effort) && (
                                            <Typography variant="caption" sx={{
                                                color: 'text.secondary',
                                                fontSize: '0.75rem', lineHeight: 1.2,
                                                display: 'block', mt: 0.25
                                            }}>
                                                {[model.duration, model.effort].filter(Boolean).join(' • ')}
                                            </Typography>
                                        )}
                                    </Box>
                                ...
                                <Collapse in={isExpanded}>
                                    ...
                                    <Box sx={{ px: 2, py: 1.5, bgcolor: theme.palette.mode === 'dark' ? 'rgba(0, 0, 0, 0.2)' : 'rgba(0, 0, 0, 0.02)' }}>
                                        ...
                                        {model.deliverables && model.deliverables.length > 0 && (
                                            <Box sx={{ mb: 1.5 }}>
